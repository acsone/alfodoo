...
class TestCmisFields(common.BaseTestCmis):
    def test_cmis_folder_get_desciption(self):
        ...
        share_location = backend_description.get("share_location")
        alfresco_api_location = backend_description.get("alfresco_api_location")
        self.assertEqual(self.cmis_backend.share_location, share_location)
        self.assertEqual(self.cmis_backend.alfresco_api_location, alfresco_api_location)
