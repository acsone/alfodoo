...
odoo.define("cmis_web.DocumentViewer", function (require) {
    ...
    var DocumentViewer = Widget.extend({
        ...
        start: function () {
            ...
            this.$(".cmis_web_viewer_img").on(
                "load",
                _.bind(this._onImageLoaded, this)
            );
        ...
        _updateContent: function () {
            this.$(".cmis_web_viewer_content").html(
                QWeb.render("cmis_web.DocumentViewer.Content", {
                    widget: this,
                })
            );
            this.$(".cmis_web_viewer_img").on(
        ...
        _zoom: function (scale) {
            ...
            this.$(".cmis_web_zoom_reset")
                .add(".cmis_web_zoom_out")
